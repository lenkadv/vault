...
### Website
- Address: https://tadylenka.substack.com
- Platform: Substack
- Notes: hlavní platforma — články i Notes; placené předplatné vypnuté

### Email and newsletter
- Channel: email
- Provider: Substack
- Destination id: tadylenka.substack.com
- Sending identity: Dějiny umění: V nejlepších letech
- Route: manual
- How far to go: safe-state
- Notes: newsletter jde přes Substack, ne přes samostatný email nástroj; píše a odesílá se ve webovém Substacku
...
- Channel: social
- Provider: Instagram + Facebook (přímo nebo přes Metricool); Substack Notes přímo v Substacku
- Destination id: [PLACEHOLDER: @tadylenka — ID profilu potvrdit, pokud se použije Metricool]
- Route: manual
- How far to go: safe-state
- Notes: DM trigger na IG = ART do komentáře → automatická DM s odkazem na Substack (ManyChat)
