...
### Website
- Address: [PLACEHOLDER: your website URL]
- Platform: [PLACEHOLDER: what it runs on]
- Notes: [PLACEHOLDER: anything the system should know]

### Email and newsletter
- Channel: email
- Provider: [PLACEHOLDER: the email tool you use]
- Destination id: [PLACEHOLDER: the list or audience ID, not its name]
- Sending identity: [PLACEHOLDER: the from-name and address subscribers see]
...
- Channel: social
- Provider: [PLACEHOLDER: the scheduler, or the platform directly]
- Destination id: [PLACEHOLDER: the page, profile, or channel ID — not the handle]
- Route: [PLACEHOLDER: connector / api / manual]
- How far to go: [PLACEHOLDER: not answered yet — read "How far GrowOS may go" below, then replace this whole placeholder with your choice]
